# -*- coding: utf-8 -*-
"""
Created on Sun Jul 12 14:46:37 2020
...
print("objective z_1 is ", pyo.value(model.z_1), "(with weighted sum)")
print("objective z_2 is ", pyo.value(model.z_2), "(with weighted sum)")
